...
SERVICES=(
  ...
  "federation|Fed — catalog (entry; mounts reviews) ★|$PORT_FED_CATALOG|GraphQL, REST|/graphql,/nexusx/er-introspection,/api/catalog_service/product_summaries,/api/catalog_service/review_summaries,/api/catalog_service/composed_review_views|uv run uvicorn demo.federation.catalog_app:app --port %PORT%"
)
