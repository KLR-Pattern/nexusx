...
SERVICES=(
  ...
  "federation|Fed — catalog (entry; mounts reviews) ★|$PORT_FED_CATALOG|GraphQL, REST|/graphql,/nexusx/er-introspection,/api/catalog_service/composed_tree|uv run uvicorn demo.federation.catalog_app:app --port %PORT%"
)
