...
class BatchRoot(BaseModel):
    """A generated ``by_<key>_in`` batch query root, with its argument contract.
...
class EntityFragment(BaseModel):
    ...
    # Generated by_<key>_in batch query roots on this type, with their argument
    # contract (name + arg_name + arg_type). Plain strings are coerced to a
